...
RUN \
    ...
    && sudo -u $USERNAME python3 -m pip config set global.index-url https://mirror.sjtu.edu.cn/pypi/web/simple \
    && cd /home/$USERNAME && curl -sL https://raw.githubusercontent.com/AUTOMATIC1111/stable-diffusion-webui/master/webui.sh | sudo -u $USERNAME env COMMANDLINE_ARGS="${BUILD_ARGS}" bash \
